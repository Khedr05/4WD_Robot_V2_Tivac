...
enu_dcm_error_t DCM_changeDCMDirection(str_dcm_confige_t *DCM_a_ptrToConfig, enu_dcm_motor_side_t DCM_a_motorNum)
{
	...
	else
	{
		...
		for( dcm_loc_loopCounter = FALSE + (DCM_a_motorNum * DCM_MAX_PIN_NUM) ; dcm_loc_loopCounter < (DCM_MAX_PIN_NUM + (DCM_a_motorNum * DCM_MAX_PIN_NUM)); dcm_loc_loopCounter++)
		{
...
enu_dcm_error_t DCM_u8SetDutyCycleOfPWM(Uint8_t DCM_a_dutyCycleValue)
{
	...
	else
	{
		...
		PWM_set_Duty(1,DCM_a_dutyCycleValue);
